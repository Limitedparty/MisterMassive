...
/*
	...
	В кратце структура матрицы (ее описывае класс ниже) выглядит так:
	...
	Перед работой с экземпляром данного класса, его нудно инициализировать. Это нужно для выделения памяти и для создания границ матрицы. 
